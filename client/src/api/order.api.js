...
export const downloadOpenOrderPdf = (po, invoiceNo) =>
  api.get('/orders/download-open-order', { params: { po, ...(invoiceNo && String(invoiceNo).toLowerCase() !== 'null' ? { invoiceNo } : {}) }, responseType: 'blob' });
