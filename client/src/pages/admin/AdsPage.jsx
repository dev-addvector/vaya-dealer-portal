  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {ads.map((ad) => (
          <div key={ad.id} className="bg-white rounded-lg shadow p-4 flex items-start justify-between">
            <div>
            ...
            <button onClick={() => remove.mutate(ad.id)} className="text-red-500 text-xs hover:underline">Delete</button>
          </div>
        ))}
      </div>
    </div>
